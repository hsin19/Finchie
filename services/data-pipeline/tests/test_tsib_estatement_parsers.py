...
from src.finchie_data_pipeline.parsers.tsib_estatement_parsers import (
    RawCardTransactions,
    _extract_bill_info,
...
def test_extract_credit_card_statement(mocker):
    ...
    mock_extract_bill = mocker.patch("src.finchie_data_pipeline.parsers.tsib_estatement_parsers._extract_bill_info")
    mock_extract_transactions = mocker.patch("src.finchie_data_pipeline.parsers.tsib_estatement_parsers._extract_transactions")
